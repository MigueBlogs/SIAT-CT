...
/* Created on:     02/08/2019 12:13:24 p.m.                     */
/*==============================================================*/

CREATE TABLESPACE tbs_siatct
DATAFILE 'C:\oracle\oradata\anrcdb\appspdb\tbs_siatct_01.dbf'
SIZE 200M
ONLINE;
...
---------------------------------------------------------------------
CREATE USER siatct
IDENTIFIED BY siatct
DEFAULT TABLESPACE tbs_siatct
QUOTA UNLIMITED ON tbs_siatct;

---------------------------------------------------------------------
-- PERMISOS
---------------------------------------------------------------------
GRANT CONNECT TO siatct;
GRANT CREATE SESSION TO siatct;

GRANT CREATE ANY TABLE TO siatct;
GRANT ALTER ANY TABLE TO siatct;
GRANT DELETE ANY TABLE TO siatct;
GRANT UPDATE ANY TABLE TO siatct;
GRANT SELECT ANY TABLE TO siatct;
GRANT INSERT ANY TABLE TO siatct;

GRANT CREATE ANY INDEX TO siatct;
GRANT ALTER ANY INDEX TO siatct;
GRANT DROP ANY INDEX TO siatct;

GRANT CREATE ANY VIEW TO siatct;
GRANT ALTER ANY VIEW TO siatct;
GRANT DROP ANY VIEW TO siatct;

GRANT CREATE ANY SEQUENCE TO siatct;
GRANT ALTER ANY SEQUENCE TO siatct;
GRANT DROP ANY SEQUENCE TO siatct;

GRANT CREATE ANY TRIGGER TO siatct;
GRANT ALTER ANY TRIGGER TO siatct;
GRANT DROP ANY TRIGGER TO siatct;
...
alter table BOLETIN
   drop constraint FK_BOLETIN_RELATIONS_CATERGOR;
...
alter table MUNICIPIO
   drop constraint FK_MUNICIPI_RELATIONS_ALERTAMI;
...
drop table CATERGORIA_EVENTO cascade constraints;
...
(
   ...
   ID_BOLETIN           NUMBER(10)           not null,
   constraint PK_ALERTAMIENTO primary key (ID_TIPO_ALERTA, ID_NIVEL_ALERTA, ID_BOLETIN)
);
...
/*==============================================================*/
/* Table: CATERGORIA_EVENTO                                     */
/*==============================================================*/
create table CATERGORIA_EVENTO 
(
   ID_CATEGORIA_EVENTO  NUMBER(1)            not null,
   NOMBRE               VARCHAR2(200)        not null,
   VALOR                NUMBER(1)            not null,
   constraint PK_CATERGORIA_EVENTO primary key (ID_CATEGORIA_EVENTO)
);
...
(
   ID_MUNICIPIO         CHAR(256)            not null,
   ID_ESTADO            NUMBER(2)            not null,
   ID_REGION            NUMBER(4)            not null,
   ID_TIPO_ALERTA       NUMBER(1),
   ID_NIVEL_ALERTA      NUMBER(1),
   ID_BOLETIN           NUMBER(10),
   NOMBRE               VARCHAR2(1024)       not null,
...
alter table BOLETIN
   add constraint FK_BOLETIN_RELATIONS_CATERGOR foreign key (ID_CATEGORIA_EVENTO)
      references CATERGORIA_EVENTO (ID_CATEGORIA_EVENTO);
...
alter table MUNICIPIO
   add constraint FK_MUNICIPI_RELATIONS_ALERTAMI foreign key (ID_TIPO_ALERTA, ID_NIVEL_ALERTA, ID_BOLETIN)
      references ALERTAMIENTO (ID_TIPO_ALERTA, ID_NIVEL_ALERTA, ID_BOLETIN);
